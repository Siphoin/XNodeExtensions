...
{
    [NodeTint("#4c4a52")]
    [CreateNodeMenu("Siphoin Unity Helpers/X Node Extensions/String/String Ends Comparison")]
    public class StringEndsWithComparisonNode : OperationStringNode<bool>
    {
        ...
        protected override bool Operation(string input)
        {
            ...
            return input.EndsWith(argument, _comparison);
        }
    }
}
