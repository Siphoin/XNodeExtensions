...
{
    [NodeTint("#4c4a52")]
    [CreateNodeMenu("Siphoin Unity Helpers/X Node Extensions/String/Get Last Index From String By Index And Count")]
    [NodeWidth(275)]
    public class GetLastIndexFromStringByIndexCount : OperationStringNode<int>
    {
        ...
        protected override int Operation(string input)
        {
            ...
            return input.LastIndexOf(value, startIndex, count);
        }
    }
}
