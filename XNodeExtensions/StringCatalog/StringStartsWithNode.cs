...
{
    [NodeTint("#4c4a52")]
    [CreateNodeMenu("Siphoin Unity Helpers/X Node Extensions/String/String Starts With")]
    public class StringStartsWithNode : OperationStringNode<bool>
    {
        ...
        protected override bool Operation(string input)
        {
            ...
            return input.StartsWith(argument);
        }
    }
}
